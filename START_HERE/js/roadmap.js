...
window.COURSES = {
  ...
  dl:         { n: 'DL Fundamentals',          i: '🕸️', href: '../dl_fundamentals/index.html',           ch: 14, hrs: '9-12 h',
    d: 'The neuron, activations, XOR, forward pass, backpropagation, training, regularisation, vanishing gradients, convolution, sequences - then PyTorch: tensors, broadcasting, an autograd graph animated forward and backward, the five-line training loop and the eight errors you will actually see.',
    why: 'Makes the transformer chapter something you understand rather than something you memorised - and the PyTorch chapter arrives after you have written backpropagation by hand, which is the only order that makes loss.backward() mean anything.' },
  ...
  sysdesign:  { n: 'AI System Design',         i: '🏗️', href: '../ai_system_design_concepts/index.html', ch: 24, hrs: '14-18 h',
    d: 'Metrics, labels, features, the model ladder, retrieval funnels, latency budgets, capacity, feedback loops, RAG at scale, vector indexes, LLM serving, Redis — plus caching layers, sharding and parallelism, Elasticsearch and BM25, big files on small machines, and the FastAPI serving layer every one of these designs ends at.',
  ...
  interview:  { n: 'AI Interview Prep',        i: '🎯', href: '../ai_interview_prep/index.html',         ch: 569, hrs: 'ongoing', unit: 'questions',
    d: '569 questions with a plain-English and a technical answer each, 236 multiple-choice questions, flashcards with spaced repetition, a timed mock interview and seven study paths.',
  ...
  tooling:    { n: 'AI Tooling Landscape',     i: '🧰', href: '../ai_tooling/index.html',                ch: 19, hrs: '5-7 h',
    d: 'Twelve layers of the AI stack and 96 named tools — LLMs, agent frameworks, RAG, embeddings, MCP, guardrails, observability, memory, agent SDKs, automation, vector databases and the FastAPI/Streamlit serving layer — with two lines and five interview points on every one.',
